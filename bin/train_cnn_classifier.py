...
train_data_iter = tfmodels.data.utils.xy_iter(x_train, y_train, FLAGS.batch_size, FLAGS.num_epochs, fill=False)
...
with graph.as_default(), sess.as_default():
    ...
    model = CNNClassifier.from_dict(model_params)
    model.print_params()
    ...
    trainer = CNNClassifierTrainer(model, train_summary_dir=train_dir)
    evaluator = CNNClassifierEvaluator(model, summary_dir=dev_dir)
